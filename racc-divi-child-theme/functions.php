...
function racc_enqueue_template_assets() {
    wp_enqueue_style(
        'racc-template-styles',
        get_stylesheet_directory_uri() . '/css/racc-template.css',
        array(),
        '1.0.0'
    );
    
    wp_enqueue_script(
        'racc-template-script',
        get_stylesheet_directory_uri() . '/js/racc-template.js',
        array('jquery'),
        '1.0.0',
        true
    );
}
add_action('wp_enqueue_scripts', 'racc_enqueue_template_assets');
...
/**
 * Enable REST API meta query filtering for pages
 */
...
/**
 * Add rendered content field to REST API for pages
 * This processes Divi shortcodes and returns the actual HTML
 */
function racc_add_rendered_content_to_rest() {
    register_rest_field(
        array('page', 'post'),
        'rendered_content',
        array(
            'get_callback' => function($object) {
                ...
                // Process shortcodes (including Divi)
            ...
            'schema' => array(
                'description' => 'Fully rendered content with shortcodes processed',
                'type'        => 'string',
...
add_action('rest_api_init', 'racc_add_rendered_content_to_rest');
