...
export const Footer = () => {
  ...
  return (
    <footer id="footer" className="bg-card-foreground dark:bg-accent-foreground text-stone-100 text-sm">
      ...
      <section className="container py-8 grid grid-cols-3 sm:grid-cols-3 md:grid-cols-5 gap-x-12 gap-y-8">
        <div className="col-span-full sm:grid-cols-1 md:col-span-2 justify-center flex">
            <a
      ...
      <section className="container pb-4 text-center text-xs sm:text-sm">
        <h3>
