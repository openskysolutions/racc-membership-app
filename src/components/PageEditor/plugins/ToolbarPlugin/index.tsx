...
function BlockFormatDropDown({
  ...
  return (
    <DropDown
      disabled={disabled}
      buttonClassName="toolbar-item block-controls h-8 rounded-sm"
...
export default function ToolbarPlugin({
  ...
  return (
    <div className="toolbar flex flex-row flex-wrap justify-between items-center py-1 gap-1">
      <div className="toolbar-left flex flex-row flex-wrap items-center gap-1">
        <Button
          disabled={!toolbarState.canUndo || !isEditable}
          onClick={(e) =>
            dispatchToolbarCommand(UNDO_COMMAND, undefined, isKeyboardInput(e.nativeEvent))
          }
        ...
        <button
          ...
          onClick={(e) =>
            dispatchToolbarCommand(REDO_COMMAND, undefined, isKeyboardInput(e.nativeEvent))
          }
        ...
        {toolbarState.blockType === 'code' && isCodeHighlighted ? (
          ...
          <>
            ...
            <button
              disabled={!isEditable}
              onClick={(e) =>
                dispatchFormatTextCommand('bold', isKeyboardInput(e.nativeEvent))
              }
              className={
            ...
            <button
              disabled={!isEditable}
              onClick={(e) =>
                dispatchFormatTextCommand('italic', isKeyboardInput(e.nativeEvent))
              }
              className={
            ...
            <button
              disabled={!isEditable}
              onClick={(e) =>
                dispatchFormatTextCommand('underline', isKeyboardInput(e.nativeEvent))
              }
              className={
                'toolbar-item ' +
            ...
            {canViewerSeeInsertCodeButton && (
              <button
                disabled={!isEditable}
                onClick={(e) =>
                  dispatchFormatTextCommand('code', isKeyboardInput(e.nativeEvent))
                }
                className={
            ...
            <button
              ...
              onClick={insertLink}
              className={
                'toolbar-item ' + (toolbarState.isLink ? 'active' : '')
              }
            ...
            <DropDown
              ...
              <DropDownItem
                onClick={(e) =>
                  dispatchFormatTextCommand('lowercase', isKeyboardInput(e.nativeEvent))
                }
                className={
              ...
              <DropDownItem
                onClick={(e) =>
                  dispatchFormatTextCommand('uppercase', isKeyboardInput(e.nativeEvent))
                }
                className={
              ...
              <DropDownItem
                onClick={(e) =>
                  dispatchFormatTextCommand('capitalize', isKeyboardInput(e.nativeEvent))
                }
                className={
              ...
              <DropDownItem
                onClick={(e) =>
                  dispatchFormatTextCommand('strikethrough', isKeyboardInput(e.nativeEvent))
                }
                className={
              ...
              <DropDownItem
                onClick={(e) =>
                  dispatchFormatTextCommand('subscript', isKeyboardInput(e.nativeEvent))
                }
                className={
              ...
              <DropDownItem
                onClick={(e) =>
                  dispatchFormatTextCommand('superscript', isKeyboardInput(e.nativeEvent))
                }
                className={
              ...
              <DropDownItem
                onClick={(e) =>
                  dispatchFormatTextCommand('highlight', isKeyboardInput(e.nativeEvent))
                }
                className={
              ...
              <DropDownItem
                onClick={(e) => clearFormatting(activeEditor, isKeyboardInput(e.nativeEvent))}
                className="item wide"
      ...
      <div className="flex flex-shrink-0 gap-1 h-full">
        <Button
          size="sm"
          variant="ghost"
